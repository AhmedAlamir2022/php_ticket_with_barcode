...
?>	
			...
			<?php echo "<img style='border:1px solid black; padding:15px;' src = 'BCG/html/image.php?filetype=PNG&dpi=72&scale=1&rotation=0&font_family=Arial.ttf&font_size=10&text=".$row['ticket_barcode']."&thickness=50&start=NULL&code=BCGcode128' />";
			?>
			</div>
