                ...
                <div class="x_panel">
                    ...
                    <div class="x_content">
                        ...
                        <div class="table-responsive">
                            ...
                            <?php
                                                $sql=mysqli_query($con,"select user.firstname,user.lastname,messages.* from messages join user on user.user_id=messages.user_id where messages.admin_id='".$_SESSION['id']."' && is_read is not null ");
                                                $cnt=1;
