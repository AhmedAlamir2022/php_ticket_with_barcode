...
$row=mysqli_fetch_array($query);
  ?>
                            ...
                            <form method="post" enctype="multipart/form-data" class="form-horizontal form-label-left">
                                <div class="form-group">
                                    ...
                                    <div class="col-md-4">
										...
										<img src="upload/<?php echo $row['ticket_image']; ?>" width="100px" height="100px" style="border:1px solid black; border-radius:5px;">
										<?php else: ?>
                    ...
                    mysqli_query($con," UPDATE tickets SET ticket_title='$ticket_title', ticket_price='$ticket_price', event='$event', status='$status', remark='$remark' WHERE ticket_id = '$id' ")or die(mysqli_error($con));
