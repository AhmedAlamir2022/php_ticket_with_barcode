...
<div id="id01" class="modal">
  ...
  <form class="modal-content animate" method="post" enctype="multipart/form-data">
    <div class="container">
      <h2 align="center">You Are Welcome To Ticket Mangement System</h2>
      ...
      <input type="text" name="qrContent" value="<?php if(isset($_POST['create'])){ echo $_POST['qrContent']; } ?>" required>
