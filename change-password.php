...
<head>
	...
	<!-- PAGE TITLE HERE ============================================= -->
	<title>Black Market || Update Password </title>
...
{ ?>
								...
								<div class="profile-tabnav">
									<ul class="nav nav-tabs">
										...
										<li class="nav-item">
											<a class="nav-link active" href="change-password.php"><i class="ti-lock"></i>Change Password</a>
										</li>
										<li class="nav-item">
								...
								<h2 class="title-head">Update  <span>Password</span></h2>
												...
												<div class="form-group row">
													...
													<div class="col-12 col-sm-9 col-md-9 col-lg-8">
														<input style="border-radius: 15px;" class="form-control" id="password" name="password"  type="password">
													</div>
												</div>
												<div class="form-group row">
													<label class="col-12 col-sm-3 col-md-3 col-lg-3 col-form-label">New Password</label>
													<div class="col-12 col-sm-9 col-md-9 col-lg-8">
														<input style="border-radius: 15px;" class="form-control" id="newpassword" type="password" name="newpassword">
													</div>
												</div>
												<div class="form-group row">
													<label class="col-12 col-sm-3 col-md-3 col-lg-3 col-form-label">Confirm Password</label>
													<div class="col-12 col-sm-9 col-md-9 col-lg-8">
														<input style="border-radius: 15px;" class="form-control" id="confirmpassword" type="password" name="confirmpassword">
												...
												<div class="">
													<div class="row">
														...
														<div class="col-12 col-sm-9 col-md-9 col-lg-">
															<button style="border-radius: 15px;" type="submit"  name="update" id="submit" class="btn">Update Password</button>
