...
<br />
							<?php
								...
								$user_query=mysqli_query($con,"select * from event_organizer where id='".$_SESSION['id']."'")or die(mysqli_error($con));
								$row=mysqli_fetch_array($user_query); 
								{
							?>        <h2><span style="font-size: 15px" class="glyphicon glyphicon-user"></span> 
								<?php echo '<span style="color:blue; font-size:13px;">Prepared by:'."<br /><br /> ".$row['first_name']." ".$row['last_name']." ".'</span>';?></h2>
								<?php } ?>
