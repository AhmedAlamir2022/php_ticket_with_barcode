                      ...
                      <div class="modal-content">
                        ...
                        <div class="clearfix"></div>
                            <ul class="nav nav-pills">
                                <li role="presentation" class="active"><a href="event.php">My Events</a></li>
                                <li role="presentation"><a href="all_events.php">All Events</a></li>
                            </ul>
                    </div>
                    <div class="x_content">
                        <!-- content starts here -->
                        ...
                        <div class="table-responsive">
                            ...
                            <tbody>
                            <?php
                                            $sql=mysqli_query($con,"select category.cat_name as catname,events.*  from events join category on category.cat_id=events.category_id where ev_or_id='".$_SESSION['id']."' order by event_added desc");
                                            $cnt=1;
