...
<script type="text/javascript">
        ...
        <div class="page-title">
            <div class="title_left">
                <h3>
                    <small>Home / E-O /</small> Change Password
                </h3>
            </div>
        </div>
                        ...
                        <!-- content starts here -->
                            ...
                            <?php
                                if(isset($_POST['submit']))
                                {
                                    ...
                                    $sql=mysqli_query($con,"SELECT password FROM  event_organizer where password='".md5($_POST['cpass'])."' && id='".$_SESSION['id']."'");
                                    $num=mysqli_fetch_array($sql);
                                    if($num>0)
                                    {
                                        $con=mysqli_query($con,"update event_organizer set password='".md5($_POST['npass'])."' where id='".$_SESSION['id']."'");
