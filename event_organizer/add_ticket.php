...
?>
  ...
  if(isset($_POST['create']))
  {
    ...
    $insQr = $meravi->insertQrr($ev_or_id,$ticket_title,$event,$ticket_type,$ticket_price,$final,$status,$start_date,$time11,$seat_num,$country,$address,$description,$duration,$ticket_code,$ticket_image,$added_by,$remark);
    if($insQr==true)
    {
                    ...
                    <div class="x_content">
                        <!-- content starts here -->
                            ...
                            <input type="hidden" name="new_barcode" value="<?php echo $new_barcode; ?>">
                                    ...
                                    <div class="col-md-6">
                                        <select name="event" style="border-radius: 10px" class="select2_single form-control" tabindex="-1" required="required">
                                            ...
                                            <?php $ret=mysqli_query($con,"select * from events");
                                                                    ...
                                                                    {
                                                                    ?>
                                            <option value="<?php echo htmlentities($row['event_id']);?>">
                                ...
                                <div class="form-group">
                                    <label class="control-label col-md-4" for="event">Ticket Type <span class="required" style="color:red;">*</span>
                                    </label>
                                    <div class="col-md-6">
                                        <select name="ticket_type" style="border-radius: 10px" class="select2_single form-control" tabindex="-1" required="required">
                                            <option value="">Select Type</option>
                                            <?php $ret=mysqli_query($con,"select * from ttypes");
                                                                    while($row=mysqli_fetch_array($ret))
                                                                    {
                                                                    ?>
                                            <option value="<?php echo htmlentities($row['type_id']);?>">
                                                                    <?php echo htmlentities($row['ttype']); }?></option>
